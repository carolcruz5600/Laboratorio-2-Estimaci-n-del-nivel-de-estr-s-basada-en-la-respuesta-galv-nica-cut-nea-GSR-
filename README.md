...
<div align="center">
<img width="375" height="500" alt="WhatsApp Image 2026-08-27 at 9 18 07 AM" src="https://github.com/user-attachments/assets/977ad1ee-a82b-4374-a633-9f9b70f03f72" />
</div>

<div align="center">
  Fig. 1. Dispositivo Vestible
</div>

Se desarrolló una muñequera ambidiestra diseñada para facilitar la adquisición de la señal GSR (respuesta galvánica de la piel). La muñequera permite ejercer una presión adecuada y constante sobre la zona de contacto, favoreciendo una correcta interacción de los sensores con la piel y, por tanto, una mejor captación de la señal.

Como parte del diseño, se incorporó un sistema de sujeción mediante velcro, que permite fijar y retirar fácilmente el circuito electrónico encargado de realizar la adquisición de la señal GSR. Este circuito funciona de manera inalámbrica, evitando que el usuario tenga que permanecer conectado físicamente a un equipo durante la toma de datos.
